                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="" name="sec_edit" class="edit" data-bs-toggle="modal" data-id="<?= $row["secID"] ?>" data-status="active"><i class="material-icons" data-bs-toggle="tooltip" title="Edit">&#xe254;</i></a>
                            ...
                            $conditions = ['secProgram' => $program, 'status' => 1];
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-warning">
                                        <a href="#statusSectionActivate" class="status" data-bs-toggle="modal" data-secid="<?php echo $row['secID']; ?>">
