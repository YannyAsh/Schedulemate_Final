                            ...
                            ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="#statusSubj" class="status delbtn" data-bs-toggle="modal" data-id="<?= $row["subID"] ?>"><i class="material-icons" data-bs-toggle="tooltip" title="Status">&#xe909;</i></a>
                    ...
                    <form method="POST" action="subject_all_process.php">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <label for="subCMO" class="upper-label">CMO</label>
                                <input type="text" placeholder="CMO No., s." name="subCMO" class="upper-form-control">
